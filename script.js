...
//     // console.log(await data4.json());
//     return await data4.json();
//   } catch (err) {
//     alert(err);
//   } finally {
//     console.log('hello');
...
// };
// // funkAsync();
// funkAsync().then(res => console.log(res));
...
//     fetch(`https://restcountries.com/v2/name/afg`),
//   ]);
//   console.log(data);
//   console.timeEnd('a');
// };
...
async function func() {
  ...
  console.log(await Promise.race([data, timeout(0.2)]));
}
